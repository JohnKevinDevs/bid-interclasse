...
export default function EptTimesPage() {
  const divisionTeams = filterTeamsByDivision(teams, "ept");
    ...
    <main>
      <Container className="py-12 sm:py-16">
        <SectionTitle
          eyebrow="EPT"
          title="Times"
          description="Equipes cadastradas para a divisao EPT."
        />
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {divisionTeams.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Os times da EPT aparecerao aqui quando forem adicionados ao JSON local."
            />
          )}
        </div>
      </Container>
