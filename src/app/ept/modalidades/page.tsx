...
export default function EptModalidadesPage() {
  const divisionSports = filterSportsByDivision(sports, "ept");
    ...
    <main>
      <Container className="py-12 sm:py-16">
        <SectionTitle
          eyebrow="EPT"
          title="Modalidades"
          description="Modalidades disponiveis para consulta na divisao EPT."
        />
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {divisionSports.length > 0 ? (
            ...
            <EmptyState
              ...
              description="As modalidades da EPT aparecerao aqui quando forem adicionadas ao JSON local."
            />
          )}
        </div>
      </Container>
