...
export default function EptAtletasPage() {
  const divisionAthletes = filterAthletesByDivision(athletes, "ept");
    ...
    <main>
      <Container className="py-12 sm:py-16">
        <SectionTitle
          eyebrow="EPT"
          title="Atletas"
          description="Lista inicial de atletas cadastrados na divisao EPT."
        />
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {divisionAthletes.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Os atletas da EPT aparecerao aqui quando forem adicionados ao JSON local."
            />
          )}
        </div>
      </Container>
